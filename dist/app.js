...
marquee.forEach((e)=>{
    ...
    const slider = new (0, _swiper.Swiper)(e, {
        ...
        breakpoints: {
            ...
            // When the window width is >= 991px
            991: {
                slidesPerView: 3,
                spaceBetween: 40
            }
...
},{"reeller":"22NRl","gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","swiper":"iM6UL"}],"22NRl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Filler", ()=>Filler);
parcelHelpers.export(exports, "Reeller", ()=>Reeller);
parcelHelpers.export(exports, "ScrollerPlugin", ()=>ScrollerPlugin);
parcelHelpers.export(exports, "default", ()=>Reeller);
function _extends() {
...
var Base = /*#__PURE__*/ function() {
   ...
   */ ;
    _proto.off = function off(event, callback) {
        if (callback) this.events[event] = this.events[event].filter(function(f) {
            return f !== callback;
        });
   ...
   */ ;
    _proto.trigger = function trigger(event) {
        ...
        this.events[event].forEach(function(f) {
            return f.call.apply(f, [
                _this,
                _this
            ].concat([].slice.call(_arguments, 1)));
        });
    };
    return Base;
}();
var Filler = /*#__PURE__*/ function(_Base) {
   ...
   */ function Filler(options) {
        ...
        /** @type {FillerOptions} **/ _this.options = _extends({}, Filler.defaultOptions, options);
        ...
        /** @type Array.<HTMLElement> **/ _this.item = [];
        _this.refresh(false);
        if (_this.options.autoUpdate) _this.bindResizeObserver();
        else _this.update();
        return _this;
    }
    /**
   ...
   */ ;
    _proto.destroy = function destroy(removeClones) {
        if (removeClones === void 0) removeClones = false;
...
var Reeller = /*#__PURE__*/ function(_Base) {
   ...
   */ function Reeller(options) {
        var _this;
        _this = _Base.call(this) || this;
        /** @type {ReellerOptions} **/ _this.options = _extends({}, Reeller.defaultOptions, options);
   ...
   */ ;
    _proto.createTimeline = function createTimeline() {
        ...
        this.tl.fromTo(this.filler.wrapper, {
            x: function x() {
                if (!_this3.options.clonesOverflow) return -(_this3.filler.calcData.fullWidth - _this3.filler.calcData.containerWidth);
   ...
   */ ;
    _proto.bindIntersectionObserver = function bindIntersectionObserver() {
        ...
        this.intersectionObserver = new IntersectionObserver(function(entries) {
            if (entries[0].isIntersecting) _this4.resume();
            else _this4.pause();
        });
   ...
   */ ;
    _proto.initPlugins = function initPlugins() {
        ...
        for(var _i = 0, _Object$entries = Object.entries(this.options.plugins); _i < _Object$entries.length; _i++){
            var _Object$entries$_i = _Object$entries[_i], name = _Object$entries$_i[0], options = _Object$entries$_i[1];
            var factory = Reeller.plugins[name];
            if (factory) this.plugin[name] = new factory(this, options);
            else console.error("Plugin " + name + " not found. Make sure you register it with Reeller.use()");
        }
    } /**
   ...
   */ ;
    _proto.destroy = function destroy(removeClones, clearProps) {
        if (removeClones === void 0) removeClones = false;
        if (clearProps === void 0) clearProps = false;
...
var ScrollerPlugin = /*#__PURE__*/ function() {
   ...
   */ function ScrollerPlugin(reeller, options) {
        /** @type {ScrollerPluginOptions} **/ this.options = _extends({}, ScrollerPlugin.defaultOptions, options);
   ...
   */ ;
    _proto.init = function init() {
        ...
        this.tickerFn = function() {
            ...
            if (!_this.options.bothDirection) velocity = Math.abs(velocity);
            if (_this.options.reversed) velocity *= -1;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iM6UL":[function(require,module,exports) {
/**
 * Swiper 11.1.3
